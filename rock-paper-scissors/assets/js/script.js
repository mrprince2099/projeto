...
const botImages = ["./assets/images/rock.png", "./assets/images/paper.png", "./assets/images/scissors.png"];
const outcomes = {
  RR: "Draw",
  RP: "BOT",
  RS: "YOU",
...
function handleOptionClick(event) {
  ...
  userResult.src = botResult.src = "./assets/rock.png";
  ...
  setTimeout(() => {
    ...
    result.textContent = userValue === botValue ? "Match Draw" : `${outcome} WiN!`;
  }, 2500);
}
